...
| Локальные адреса | Фильтры по базе, статусы `unused`/`used`/`trash`, синхронизация из iCloud, экспорт CSV. |
| Ящик | Настройка IMAP, синхронизация почты, коды подтверждения, отметка о прочтении. |
| Партии | Создание, пауза, возобновление, остановка и просмотр партий. |
